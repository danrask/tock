;(function(factory) {
    ...
    var scaleSlider = function (input, options, plugin_count) {
        this.VERSION = "2.2.0";
        this.input = input;
    ...
    scaleSlider.prototype = {
        ...
        destroy: function () {
            ...
            $.data(this.input, "scaleSlider", null);
    ...
    $.fn.scaleSlider = function (options) {
        return this.each(function() {
            if (!$.data(this, "scaleSlider")) {
                $.data(this, "scaleSlider", new scaleSlider(this, options, plugin_count++));
            }
        });
    };
